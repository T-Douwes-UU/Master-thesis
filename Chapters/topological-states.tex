...
\begin{figure}[htb!]
	...
	\begin{subfigure}{.3\textwidth}
		...
		\begin{tikzpicture}
			...
			\end{axis}
		\end{tikzpicture}
		\caption{$v=0.3$, $w=0.5$} %TODO
	\end{subfigure}
	\caption{Contours in Hamiltonian space for (a) trivial, (b) conducting and (c) topological phases.} %TODO
	\label{fig:phases}
\end{figure}
