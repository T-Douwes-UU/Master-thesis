...
\subsection{Technical notes \red{[unsure what to call this section]}}
...
\begin{figure}[htb!]
	\centering
	\subcaptionbox{$-\pi \leq k_y \leq 0$} {\includegraphics[width=.3\textwidth]{Images/BZ_basic}}
	\hfil
...
\end{figure}
As such, $\h$ should be thought of as a more abstract map $K^2\times S^1\to\R^3$ rather than a tangent vector field, and Poincar\'e--Hopf does not apply to such maps.\footnote{
...
Such Weyl points are physically fine-tuned and are expected to split into pairs under perturbations. Nevertheless, the existence of additional symmetries which force Weyl points to exist on these lines cannot be ruled out a priori. Moreover, the notion of a fundamental Brillouin zone is (sensibly) predicated on a free group action in the main text of Ref. \cite{Fonseca-Vaidya_nonorientable}, and analysis of a purely $\RP^2\times S^1$ Brillouin zone cannot be expected to provide the correct classification for this double glide symmetry. Indeed, similar to the case of time-reversal, a proper classification scheme should involve equivariant cohomology on the torus, bearing in mind the topological role of the high-symmetry points.\footnote{
