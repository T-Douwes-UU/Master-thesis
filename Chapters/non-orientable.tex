...
{\color{blue}
\begin{itemize}
	\item Fonseca, Vaidya et al.\ report on the properties of Weyl points in a $K^2\times S^1$ Brillouin zone \cite{Foncesca-Vaidya_nonorientable}. This is achieved using a momentum space glide symmetry:
	\begin{equation*}
...
{\color{blue}
\begin{itemize}
	\item This section contains novel topological analysis of the setup described in \cite{Foncesca-Vaidya_nonorientable}.
	
	\item There is nothing exceptional about the planes $k_y = -\pi$ and $k_y = 0$ in this context, and the EBZ may be parametrised in a way that does not avoid them. Relative chiralities may change with respect to this parametrisation.
	
	\item The $\R P^2$ case is more complicated mathematically than is acknowledged in \cite{Foncesca-Vaidya_nonorientable}, as the total group action is not free in this case. 
